export const apiRoutes = [
  ...
  },
  {
    ...
    handlerFile: 'api-handlers/auth/verify-email.js',
  },
  {
    pattern: '/comments',
  ...
  {
    pattern: '/comments/:id/messages',
    handlerKey: 'commentMessages',
    handlerFile: 'api-handlers/comments/[id]/messages.js',
  },
  {
    pattern: '/comments/:id',
  ...
  {
    pattern: '/users/:id/request-email-change',
    handlerKey: 'userRequestEmailChange',
    handlerFile: 'api-handlers/users/[id]/request-email-change.js',
  },
  {
